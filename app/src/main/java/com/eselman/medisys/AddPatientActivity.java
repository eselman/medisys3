...
public class AddPatientActivity extends AppCompatActivity implements SavePatientClientTask.Callback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_add_patient);
         ...
         getSupportActionBar().setTitle(R.string.add_patient_title);
         ...
         getSupportFragmentManager().beginTransaction().add(R.id.patient_add_fragment, editPatientFragment).commit();
    }
